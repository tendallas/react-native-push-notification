...
Notifications.configure = function(options) {
  ...
  if ( this.isLoaded === false ) {
    ...
    PlatformOS === 'android' ? this.callNative( 'addEventListener', [ 'remoteFetch', this._onRemoteFetch ] ) : null
...
Notifications.unregister = function() {
  ...
  PlatformOS === 'android' ? this.callNative( 'removeEventListener', [ 'remoteFetch', this._onRemoteFetch ] ) : null
  this.isLoaded = false;
};
